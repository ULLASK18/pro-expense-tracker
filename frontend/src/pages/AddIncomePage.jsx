...
const AddIncomePage = () => {
  ...
  const categories = ['Salary', 'Freelance', 'Investment', 'Gift', 'Business', 'Rental', 'Other'];
  ...
  return (
    <div className="container mx-auto px-6 max-w-2xl pt-24 pb-12">
      <motion.div
        ...
        className="glass-card p-8 md:p-12 border-l-4 border-green-500"
      >
        <div className="flex items-center gap-4 mb-10">
          <div className="w-12 h-12 bg-green-500/10 rounded-2xl flex items-center justify-center text-green-500">
            <PlusCircle size={28} />
          </div>
          <h2 className="text-3xl font-black">Add New Income</h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-green-600 hover:bg-green-700 py-4 rounded-2xl font-black text-lg shadow-glow transition-all flex justify-center items-center gap-2 disabled:opacity-50 mt-4"
          >
